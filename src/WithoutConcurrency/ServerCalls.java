...
public class ServerCalls {
    ...
    private String getProductDetail(String productId) {
        ...
        try {
            //assume thread.sleep() was a call to server, and it took 2000 milliseconds to get a response.
            Thread.sleep(2000);
            //assume this is the value we got from server after waiting for 2000 milliseconds.
            return "Samsung S23";
